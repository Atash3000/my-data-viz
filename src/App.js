...
import { DeviatedBarChart } from './components/DeviatedBar'
import { DeviatedBarChart2 } from './components/Deviated2'
import { HorizontalBarChartNegative } from './components/HorizontalNegative'
import { DeviatedBarChart3 } from './components/DeviatedBar3'
  ...
  return (
    <div className='App'>
      ...
      <div className='flex'>
        ...
        <PieChart />
        <HorizontalBarChartNegative data={dataNegative} width={width} height={height} />
        <DeviatedBarChart data={data} width={width} height={height} target={value} />
        {/* <DeviatedBarChart2 data={data} width={width} height={height} target={value} /> */}

        <DeviatedBarChart3 data={dataNegative} width={width} height={height} target={value} />
      </div>
      <div className='input-container'>
        <label htmlFor='target'>Enter Target value</label>
        <input onChange={event => setValue(Number(event.target.value))} className='input' id='target' name='target' type='number' />
      </div>
    </div>
  )
}
